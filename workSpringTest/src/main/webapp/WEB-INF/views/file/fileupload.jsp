...
<script src="https://kit.fontawesome.com/aec6c4c98a.js" crossorigin="anonymous"></script>
<script type="text/javascript">
	...
	function checkExtension(fileName, fileSize){
		...
		// .exe, .sh, .zip, .alz 으로 끝나는 문자열
		// 정규표현식 : 특정 규칙을 가진 문자열을 검색하거나 치환 할 때 사용
...
<body>
	...
	<div id="divFileuploadRes">res : ${param.msg }</div>
