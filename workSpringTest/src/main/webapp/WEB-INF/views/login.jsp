...
<main class="form-signin w-100 m-auto">
  ...
  <form name='signinForm'>
    ...
    <div class="form-floating">
      <input type="text" class="form-control start" required="required" id="id" placeholder="idLove">
...
<%@ page import="java.math.BigInteger" %>
  ...
  <%
    String clientId = "pZ0yhwB_HpxsrQ9gB5dr";//애플리케이션 클라이언트 아이디값";
    String redirectURI = URLEncoder.encode("http://localhost:8080/login/naver_callback", "UTF-8"); // 콜백 URL
    SecureRandom random = new SecureRandom();
    String state = new BigInteger(130, random).toString();
    
    // 요청 URL -> 네이버로그인 및 사용자 정보 제공 동의 -> 콜백으로 코드를 제공
